...
//
// **Где живут вкладки.** Само состояние — в `SaleModel`, ровно столько,
// сколько живёт модель. Снимок вкладок при этом пишется в `GetStorage`
// (`sale_session.dart`), чтобы перезапуск приложения не стоил кассиру набранной
// корзины. Опасность, ради которой десктоп держит вкладки в `sessionStorage`, —
// чек недельной давности, всплывший поверх новой смены, — снимается там
// подписью кассой, сменой и кассиром и сроком жизни снимка.
//
